...
train_pipeline = [
    ...
    dict(type='CSPMaps', radius=8, stride=4, regress_range=(-1, 1e8), image_shape=img_scale, num_classes=1),
...
data = dict(
    ...
    train=dict(
        type="CocoDataset",
        classes=classes,
        ann_file=data_root + "labels/det_20/det_train_v_coco.json",
    ...
    val=dict(
        type="CocoDataset",
        classes=classes,
        ann_file=data_root + "labels/det_20/det_val_v_coco.json",
