...
lr_config = dict(step=[80, 120], policy='step', warmup='constant', warmup_iters=250, warmup_ratio=1.0/3,)
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project="BDD100KDet",
                entity="hannankhan",
                name="lsfm_4x12_bddk_norm_res_90",
                config=dict(
                    work_dirs="${work_dir}",
...
resume_from="./work_dirs/bdd100k_4x8_lsfm_hrnet/epoch_110.pth"
