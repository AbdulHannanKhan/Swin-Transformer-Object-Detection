...
train_pipeline = [
    ...
    dict(type='CSPMaps', radius=3, stride=4, regress_range=(-1, 1e8), image_shape=img_scale, num_classes=80),
...
resume_from="./work_dirs/coco_4x6_lsfm_hrnet_sm8/epoch_16.pth"
