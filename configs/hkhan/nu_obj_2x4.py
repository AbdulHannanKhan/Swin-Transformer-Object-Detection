...
data = dict(
    ...
    train=dict(
        type="CocoDataset",
        classes=['car', 'truck', 'trailer', 'bus', 'construction_vehicle', 'bicycle', 'motorcycle' ,'pedestrain', 'traffic_cone', 'barrier'],
        ann_file="/netscratch/hkhan/annotation/nuscenes_infos_train_mono3d.coco.json",
    ...
    val=dict(
        type="CocoDataset",
        classes=['car', 'truck', 'trailer', 'bus', 'construction_vehicle', 'bicycle', 'motorcycle' ,'pedestrain', 'traffic_cone', 'barrier'],
        ann_file="/netscratch/hkhan/annotation/nuscenes_infos_val_mono3d.coco.json",
        img_prefix="/netscratch/hkhan/nuscenes/raw/",
