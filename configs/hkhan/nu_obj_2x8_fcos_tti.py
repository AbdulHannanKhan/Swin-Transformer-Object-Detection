...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_mask=False, with_tti=True),
    ...
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels', 'gt_tti']),
]
...
# resume_from="./work_dirs/nu_obj_2x8_fcos/epoch_1.pth"
