...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        'datasets/pedestrian_datasets/CityPersons/train_cp_new_mmdet.json',
        img_prefix='datasets/pedestrian_datasets/CityPersons/',
        classes=['person'],
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        'datasets/pedestrian_datasets/CityPersons/val_gt_for_mmdetction.json',
        img_prefix=
        'datasets/pedestrian_datasets/CityPersons//leftImg8bit_trainvaltest/leftImg8bit/val_all_in_folder/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
